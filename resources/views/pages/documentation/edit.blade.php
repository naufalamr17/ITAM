<x-layout bodyClass="g-sidenav-show  bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage="EDIT DOCUMENTATION"></x-navbars.navs.auth>
        <!-- End Navbar -->
                        ...
                        <div class="container">
                            ...
                            <form action="{{ route('documentation.update', $documentation->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group mt-3 mb-3">
                                    ...
                                    <input type="text" name="judul" id="judul" class="form-control border p-2" value="{{ old('judul', $documentation->judul) }}" required>
                                    @error('judul')
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="file" name="file" id="file" class="form-control border p-2">
                                    @error('file')
                                    <small class="text-danger">{{ $message }}</small>
                                    @enderror

                                    @if($documentation->file_path)
                                    <small>Current file: <a href="{{ asset('storage/' . $documentation->file_path) }}" target="_blank">View File</a></small>
                                    @endif
                                </div>
